  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-4">
        ...
        {!userType ? (
          <div
            className={`cursor-pointer ${getNavLinkClass("/")}`}
            onClick={() => navigate("/")}
          >
            Home
          </div>
          ...
          <>
            <div
              className={`cursor-pointer ${getNavLinkClass("/jobslist")}`}
            ...
            {userType === "employer" && (
              <div
                ...
                onClick={() => navigate("/developerlist")}
              >
                Developer List
              </div>
            )}
            <div
              className={`cursor-pointer ${getNavLinkClass("/profile")}`}
